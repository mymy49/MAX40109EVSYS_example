...
namespace led
{
	 ...
	 *
	 * @details
	 * Turns the Red LED on or off. The underlying GPIO pin (P0.29) is
	 * active-low; the driver inverts the signal internally so callers
	 * always use logical ON/OFF semantics.
	 *
	 ...
	 *
	 * @details
	 * Turns the Blue LED on or off. The underlying GPIO pin (P0.30) is
	 * active-low; the driver inverts the signal internally.
	 *
	 ...
	 *
	 * @details
	 * Turns the Green LED on or off. The underlying GPIO pin (P0.31) is
	 * active-low; the driver inverts the signal internally.
	 *
